            ...
            <SafeAreaView style={{ ...GlobalStyles.droidSafeArea, backgroundColor: "white" }}>
                <TouchableWithoutFeedback onPress={() => { Keyboard.dismiss() }}>
                    <View style={styles.mainView}>
                        ...
                        <StatusBar animated={true} showHideTransition='fade' barStyle='dark-content' backgroundColor="#f3f3f3" />

                        <Header currentPage={"SettingsUp"} />
                        ...
                        <Header currentPage={"SettingsDown"} />
